import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, getQuery, getCookie, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/henridelozanne/Developer/blog/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/henridelozanne/Developer/blog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/henridelozanne/Developer/blog/node_modules/devalue/index.js';
import destr from 'file:///Users/henridelozanne/Developer/blog/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative, parseURL, withoutBase, getQuery as getQuery$1, joinRelativeURL } from 'file:///Users/henridelozanne/Developer/blog/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/henridelozanne/Developer/blog/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/henridelozanne/Developer/blog/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/henridelozanne/Developer/blog/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/henridelozanne/Developer/blog/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/henridelozanne/Developer/blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/henridelozanne/Developer/blog/node_modules/defu/dist/defu.mjs';
import { kebabCase, pascalCase, camelCase, snakeCase } from 'file:///Users/henridelozanne/Developer/blog/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/henridelozanne/Developer/blog/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/henridelozanne/Developer/blog/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/henridelozanne/Developer/blog/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/henridelozanne/Developer/blog/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/henridelozanne/Developer/blog/node_modules/vue/index.mjs';
import { extname, join } from 'file:///Users/henridelozanne/Developer/blog/node_modules/pathe/dist/index.mjs';
import { hash as hash$1 } from 'file:///Users/henridelozanne/Developer/blog/node_modules/ohash/dist/index.mjs';
import { unified } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unified/index.js';
import { toString } from 'file:///Users/henridelozanne/Developer/blog/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///Users/henridelozanne/Developer/blog/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///Users/henridelozanne/Developer/blog/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/henridelozanne/Developer/blog/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/henridelozanne/Developer/blog/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/henridelozanne/Developer/blog/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///Users/henridelozanne/Developer/blog/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///Users/henridelozanne/Developer/blog/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///Users/henridelozanne/Developer/blog/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/henridelozanne/Developer/blog/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/henridelozanne/Developer/blog/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/henridelozanne/Developer/blog/node_modules/remark-rehype/index.js';
import { all } from 'file:///Users/henridelozanne/Developer/blog/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///Users/henridelozanne/Developer/blog/node_modules/detab/index.js';
import { u as u$1 } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unist-builder/index.js';
import { encode } from 'file:///Users/henridelozanne/Developer/blog/node_modules/mdurl/index.js';
import slugify from 'file:///Users/henridelozanne/Developer/blog/node_modules/slugify/slugify.js';
import { position } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unist-util-position/index.js';
import { visit } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unist-util-visit/index.js';
import { FontStyle, BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///Users/henridelozanne/Developer/blog/node_modules/shiki-es/dist/shiki.node.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/henridelozanne/Developer/blog/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/henridelozanne/Developer/blog/node_modules/@unhead/shared/dist/index.mjs';
...
const _tqLT5I718E = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/henridelozanne/Developer/blog";
...
async function parse(file, userOptions = {}) {
  ...
  const excerpt = excerptString ? await generateBody(excerptString, { ...options, data }) : undefined;
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/henridelozanne/Developer/blog/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const serverAssets = [{"baseName":"server","dir":"/Users/henridelozanne/Developer/blog/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/henridelozanne/Developer/blog/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/henridelozanne/Developer/blog/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/henridelozanne/Developer/blog","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/henridelozanne/Developer/blog/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/henridelozanne/Developer/blog/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/henridelozanne/Developer/blog/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/henridelozanne/Developer/blog/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _I9TIWt = defineEventHandler(async (event) => {
...
const _wgEG6n = defineEventHandler(async (event) => {
...
const _ln23A4 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_pOTIFK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_pOTIFK, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _I9TIWt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _I9TIWt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _I9TIWt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _wgEG6n, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _ln23A4, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _ln23A4, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _ln23A4, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_pOTIFK, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/henridelozanne/Developer/blog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/henridelozanne/Developer/blog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
